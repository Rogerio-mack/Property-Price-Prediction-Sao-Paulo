...
Avaliar diferentes modelos para a de predição de preço de venda de imóveis ofertados em plataformas plataformas online. 
Particularmente, comparar o uso de modelos de regressão linear, indicados  como padrão pela ABNT, e de modelos de aprendiza
